        ...
        <div className="container animate-in fade-in slide-in-from-top-12 duration-500">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-sora font-bold mb-6 text-gray-900">
              Banking Compliance, Digital Transformation & Customer Experience
            </h1>
            <p className="text-lg md:text-xl text-gray-600 mb-8">
              MAVYN: Integrated expertise from former UAE bank leaders. We help SMEs and fintech companies navigate compliance, transform customer journeys, and scale with confidence.
            </p>
